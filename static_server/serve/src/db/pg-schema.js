import { index, bigint, pgTable, text, jsonb, uniqueIndex } from 'drizzle-orm/pg-core';
...
export const stockAnalyses = pgTable('stock_analyses', {
  ...
  input: jsonb('input_json').notNull(),
  analysis: jsonb('analysis_json'),
  error: text('error'),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
}, (table) => [
...
export const chatMessages = pgTable('chat_messages', {
  ...
  contents: jsonb('contents_json').notNull(),
